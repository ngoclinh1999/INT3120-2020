...
const PickNewWord = props => {
  ...
  return (
    <View style={{flex: 1}}>
      <StatusBar backgroundColor="#009dd6" barStyle="light-content" />
      ...
      <LinearGradient
        ...
        <View
          ...
          <View style={{flex: 1, display: 'flex', flexDirection: 'row'}}>
            <Text style={{color: '#e7e7e7', fontSize: 16, marginRight: 5}}>
              Đã chọn 6 chủ đề
            </Text>
            <Icon name="edit" color="#e7e7e7" />
          </View>
          <View style={{flex: 1, display: 'flex', flexDirection: 'row'}}>
            <Text style={{color: '#e7e7e7', fontSize: 14, marginRight: 5}}>
              Từ vựng IELTS; Từ vựng TOEIC
            </Text>
          </View>
        </View>
      </LinearGradient>

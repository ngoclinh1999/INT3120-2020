...
const SignUp = props => {
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <View
        style={{flex: 4, flexDirection: 'column', justifyContent: 'flex-end'}}>
        <Input
          placeholder="Email"
          leftIcon={<Icon name="email" size={20} color="#E0E0E0" />}
        ...
        <Input
          ...
          leftIcon={<Icon name="lock" size={20} color="#E0E0E0" />}
          secureTextEntry
          leftIconContainerStyle={{marginLeft: 0}}
      ...
      <View
        ...
        <Button
          ...
          onPress={() => {
            handleSignUp(email, pass, confimPass);
          }}
        />
        <Text style={{marginTop: 10, marginBottom: 10, color: '#9E9E9E'}}>
          --hoặc--
        </Text>
        <Button
          title="Đăng nhập"

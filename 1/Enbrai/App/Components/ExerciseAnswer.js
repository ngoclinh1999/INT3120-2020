      ...
      <View>
        ...
        <View
          ...
          <Text style={{fontSize: 18, color: '#424242'}}>
            ...
            <Text style={{fontSize: 18, color: '#424242'}}>{eg2[1]}</Text>
          </Text>
        </View>
        <View
          style={{
          ...
          <Text style={{fontSize: 18, color: '#424242', marginBottom: 10}}>
            Bạn cần hoàn thành từ{' '}
            <Text style={{fontWeight: 'bold'}}>
              {props.questCount - props.questCompleteCount}
            </Text>{' '}
            nữa để mở khóa{' '}
            <Text style={{fontWeight: 'bold'}}>level {props.levelIndex}</Text>
          </Text>
          <ProgressBarAndroid

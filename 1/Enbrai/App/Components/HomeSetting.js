...
const HomeSetting = props => {
  ...
  const fetchData = async () => {
    var data = await AsyncStorage.multiGet([
      'Language',
      'Topic',
      'NumberWord',
      'Voice',
  ...
  const radio_props = [{label: 'US', value: 0}, {label: 'UK', value: 1}];
  return (
    <View style={{flex: 1, backgroundColor: '#fff'}}>
      ...
      <TouchableOpacity
        ...
        <View style={{flexDirection: 'row', marginTop: 20}}>
          <View style={{flex: 8, flexDirection: 'column'}}>
            ...
            <Text style={{fontSize: 14, marginTop: 8, color: '#757575'}}>
              {language == 0 ? 'Tiếng Việt' : 'Tiếng Anh'}
            </Text>
          </View>
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          props.navigation.navigate('TopicScreen', {topic: topic});
        }}>
        <View style={{flexDirection: 'row', marginTop: 20}}>
          <View style={{flex: 8, flexDirection: 'column'}}>
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          props.navigation.navigate('SetNumberWordScreen', {
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          props.navigation.navigate('SetNotificationScreen', {time: time});
        }}>
        <View style={{flexDirection: 'row', marginTop: 20}}>
          <View style={{flex: 8, flexDirection: 'column'}}>

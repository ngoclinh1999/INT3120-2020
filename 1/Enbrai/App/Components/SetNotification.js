  ...
  return (
    <View style={{flex: 1, flexDirection: 'column'}}>
      ...
      <View style={{flex: 9}}>
        ...
        <View
          style={{marginTop: maxheight * 0.08, marginLeft: maxheight * 0.05}}>
          <Text style={{fontSize: 16}}>Bật lời nhắc nhở</Text>
          <View
            style={{
              marginTop: maxheight * 0.02,
              marginLeft: maxheight * 0.02,
        ...
        <View
          style={{marginTop: maxheight * 0.05, marginLeft: maxheight * 0.05}}>
          <Text style={{fontSize: 16}}>Chọn thời gian phù hợp</Text>
          <View
            style={{
              marginTop: maxheight * 0.02,
              marginLeft: maxheight * 0.02,
              marginRight: maxheight * 0.05,
            }}>
            <Slider
              value={time}
              disabled={!isEnabled}
